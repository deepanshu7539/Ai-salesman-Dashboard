...
const FollowUp: React.FC<{ onChange: (text: string) => void }> = ({ onChange }) => {
  const [text, setText] = useState<string>('');
  const instructions = [
    "Describe how the AI should behave on the follow-up phone call.",
  ...
  return (
    <div className='flex items-start justify-center rounded-md bg-white p-4'>
      <div className="w-full bg-white rounded-lg shadow-md p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Enter your follow-up instructions</h2>
